...
/* package enm-0.1.0.0 */
#ifndef VERSION_enm
#define VERSION_enm "0.1.0.0"
#endif /* VERSION_enm */
#ifndef MIN_VERSION_enm
#define MIN_VERSION_enm(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_enm */
...
#define CURRENT_COMPONENT_ID "enm-0.1.0.0-inplace-enm"
